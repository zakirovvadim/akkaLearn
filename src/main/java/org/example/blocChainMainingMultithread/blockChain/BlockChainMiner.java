...
import org.example.blocChainMainingMultithread.blockChain.ManagerBehavior;
import org.example.blocChainMainingMultithread.model.Block;
import org.example.blocChainMainingMultithread.model.BlockChain;
import org.example.blocChainMainingMultithread.model.BlockValidationException;
...
public class BlockChainMiner {
	...
	private void mineNextBlock() {
		...
		if (nextBlockId < 10) {
			...
			Block block = utils.BlocksData.getNextBlock(nextBlockId, lastHash);
